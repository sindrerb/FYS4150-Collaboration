...
public:
    ...
    static vec3 solveVerletPos(vec3 x, vec3 dx, vec3 ddx, double step, double halfStepSquared);
    static vec3 solveVerletVel(vec3 dx, vec3 ddx1, vec3 ddx0, double halfStep);
